...
return array(
    ...
    'TMPL_PARSE_STRING' => array(
        ...
        '__SERVICE_JS__'     => __ROOT__ . '/Public/Service/js',
        '__SERVICE_GRF__'     => __ROOT__ . '/Public/Service/grf',
        '__SERVICE_CSS__'     => __ROOT__ . '/Public/Service/css',
        '__SERVICE_IMG__'     => __ROOT__ . '/Public/Service/img',
        '__SERVICE_UPLOADIFY__'     => __ROOT__ . '/Public/Service/uploadify',
        '__Map__' => __ROOT__ . '/Public/Static/BaiduMap',
