window.BMAP_AUTHENTIC_KEY = "qOWaFQYywwaCM5KRb5wRotjr";
// SERVER_URL="192.168.0.179/baidumap/";
SERVER_URL=window.location.host+"/CourtGms/redirect.php?";
(function() {
    function aa(a) {
        throw a;
    }
    ...
    x.D.tj = function(a, b) {
        ...
        var b = x.Sk.oO(b),
            d = a.style[b];
        if (!d) var e = c.DB[b],
        d = a.currentStyle || (x.ea.la ? a.style : getComputedStyle(a, p)), d = e && e.get ? e.get(a, d) : d[e || b];
    ...
    z.RL = {
        TILE_BASE_URLS: [SERVER_URL+"ss0.baidu.com/5bwHcj7lABFU8t_jkk_Z1zRvfdw6buu", SERVER_URL+"ss0.baidu.com/5bwHcj7lABFV8t_jkk_Z1zRvfdw6buu", SERVER_URL+"ss0.baidu.com/5bwHcj7lABFS8t_jkk_Z1zRvfdw6buu", SERVER_URL+"ss0.bdstatic.com/5bwHcj7lABFT8t_jkk_Z1zRvfdw6buu", SERVER_URL+"ss0.bdstatic.com/5bwHcj7lABFY8t_jkk_Z1zRvfdw6buu"],
        TILE_ONLINE_URLS: [SERVER_URL+"ss0.bdstatic.com/8bo_dTSlR1gBo1vgoIiO_jowehsv", SERVER_URL+"ss0.bdstatic.com/8bo_dTSlRMgBo1vgoIiO_jowehsv", SERVER_URL+"ss0.bdstatic.com/8bo_dTSlRcgBo1vgoIiO_jowehsv", SERVER_URL+"ss0.bdstatic.com/8bo_dTSlRsgBo1vgoIiO_jowehsv", SERVER_URL+"ss0.bdstatic.com/8bo_dTSlQ1gBo1vgoIiO_jowehsv"],
        TIlE_PERSPECT_URLS: [SERVER_URL+"ss0.bdstatic.com/-OR1cTe9KgQFm2e88IuM_a", SERVER_URL+"ss0.bdstatic.com/-ON1cTe9KgQFm2e88IuM_a", SERVER_URL+"ss0.bdstatic.com/-OZ1cTe9KgQFm2e88IuM_a", SERVER_URL+"ss0.bdstatic.com/-OV1cTe9KgQFm2e88IuM_a"],
        geolocControl: SERVER_URL+"sp2.baidu.com/8LkJsjOpB1gCo2Kml5_Y_D3",
        TILES_YUN_HOST: [SERVER_URL+"sp0.baidu.com/-eR1bSahKgkFkRGko9WTAnF6hhy", SERVER_URL+"sp0.baidu.com/-eN1bSahKgkFkRGko9WTAnF6hhy", SERVER_URL+"sp0.baidu.com/-eZ1bSahKgkFkRGko9WTAnF6hhy", SERVER_URL+"sp0.baidu.com/-eV1bSahKgkFkRGko9WTAnF6hhy"],
        traffic: SERVER_URL+"sp3.baidu.com/7_AZsjOpB1gCo2Kml5_Y_DAcsMJiwa",
        iw_pano: SERVER_URL+"ss0.bdstatic.com/5LUZemba_QUU8t7mm9GUKT-xh_",
        message: SERVER_URL+"sp0.baidu.com/7vo0bSba2gU2pMbgoY3K",
        baidumap: SERVER_URL+"sp0.baidu.com/80MWsjip0QIZ8tyhnq",
        wuxian: SERVER_URL+"sp0.baidu.com/6a1OdTeaKgQFm2e88IuM_a",
        pano: [SERVER_URL+"ss0.bdstatic.com/5LUZemba_QUU8t7mm9GUKT-xh_", SERVER_URL+"ss0.bdstatic.com/5LUZemfa_QUU8t7mm9GUKT-xh_", SERVER_URL+"ss0.bdstatic.com/5LUZemja_QUU8t7mm9GUKT-xh_"],
        main_domain_nocdn: {
            baidu: SERVER_URL+"sp0.baidu.com/9_Q4sjOpB1gCo2Kml5_Y_D3",
            other: SERVER_URL+"api.map.baidu.com"
        },
        main_domain_cdn: {
            baidu: [SERVER_URL+"ss0.bdstatic.com/9_Q4vHSd2RZ3otebn9fN2DJv", SERVER_URL+"ss0.baidu.com/9_Q4vXSd2RZ3otebn9fN2DJv", SERVER_URL+"ss0.bdstatic.com/9_Q4vnSd2RZ3otebn9fN2DJv"],
            other: [SERVER_URL+"api.map.baidu.com"],
            webmap: [SERVER_URL+"ss0.baidu.com/6b1IcTe9R1gBo1vgoIiO_jowehsv"]
        },
        map_click: SERVER_URL+"sp0.baidu.com/80MWbzKh2wt3n2qy8IqW0jdnxx1xbK",
        vector_traffic: SERVER_URL+"ss0.bdstatic.com/8aZ1cTe9KgQIm2_p8IuM_a"
    };
    z.XX = {
        TILE_BASE_URLS: [SERVER_URL+"shangetu0.map.bdimg.com", SERVER_URL+"shangetu1.map.bdimg.com", SERVER_URL+"shangetu2.map.bdimg.com", SERVER_URL+"shangetu3.map.bdimg.com", SERVER_URL+"shangetu4.map.bdimg.com"],
        TILE_ONLINE_URLS: [SERVER_URL+"online0.map.bdimg.com", SERVER_URL+"online1.map.bdimg.com", SERVER_URL+"online2.map.bdimg.com", SERVER_URL+"online3.map.bdimg.com", SERVER_URL+"online4.map.bdimg.com"],
        TIlE_PERSPECT_URLS: [SERVER_URL+"d0.map.baidu.com", SERVER_URL+"d1.map.baidu.com", SERVER_URL+"d2.map.baidu.com", SERVER_URL+"d3.map.baidu.com"],
        geolocControl: SERVER_URL+"loc.map.baidu.com",
        TILES_YUN_HOST: [SERVER_URL+"g0.api.map.baidu.com", SERVER_URL+"g1.api.map.baidu.com", SERVER_URL+"g2.api.map.baidu.com", SERVER_URL+"g3.api.map.baidu.com"],
        traffic: "its.map.baidu.com:8002",
        iw_pano: SERVER_URL+"pcsv0.map.bdimg.com",
        message: SERVER_URL+"j.map.baidu.com",
        baidumap: SERVER_URL+"map.baidu.com",
        wuxian: SERVER_URL+"wuxian.baidu.com",
        pano: [SERVER_URL+"pcsv0.map.bdimg.com", SERVER_URL+"pcsv1.map.bdimg.com", SERVER_URL+"pcsv2.map.bdimg.com"],
        main_domain_nocdn: {
            baidu: SERVER_URL+"api.map.baidu.com"
        },
        main_domain_cdn: {
            baidu: [SERVER_URL+"api0.map.bdimg.com", SERVER_URL+"api1.map.bdimg.com", SERVER_URL+"api2.map.bdimg.com"],
            webmap: [SERVER_URL+"webmap0.map.bdimg.com"]
        },
        map_click: SERVER_URL+"mapclick.map.baidu.com",
        vector_traffic: SERVER_URL+"or.map.bdimg.com"
    };
    z.U_ = {
        "0": {
            proto: "http://",
    ...
    var F = {
        ...
        XF: new L(13, 1),
        pa: z.ma + "images/",
        R2: SERVER_URL+"api0.map.bdimg.com/images/",
        ...
        var l = {
            send: function(a) {
                ...
                0 < f.length && (b(f, function(d, e) {
                    ...
                    e.push(a + "=" + b)
                }), e.push("d=[" + c.join(",") + "]"), g ? e.push("_st=" + g) : e.push("_t=" + +new Date), f = new Image, f.src = SERVER_URL+"static.tieba.baidu.com/tb/pms/img/st.gif?" + e.join("&"), window["___pms_img_" + 1 * new Date] = f)
            }
        };
        a.prototype = {
            pc: function(a, b) {
        ...
        (function(a, b, c) {
            ...
            if (k && k.an && i() < k.an) {
                ...
                c.alog("monkey.create", {
                    ...
                    pid: "241",
                    p: "18",
                    ky: SERVER_URL+"nsclick.baidu.com/u.gif",
                    M3: {
                        K3: 1
                    }
                });
            ...
            l && (l.an && i() < l.an) && (c.alog("cus.on", "time", function(a) {
                ...
                dv: 3,
                ky: SERVER_URL+"static.tieba.baidu.com/tb/pms/img/st.gif",
                page: g,
                p: "18"
            }))
        })(a, b, c)
    ...
    Fe.prototype = {
        ...
        EU: function(a) {
            ...
            else return; if ("zoom" == b.options.SO) {
