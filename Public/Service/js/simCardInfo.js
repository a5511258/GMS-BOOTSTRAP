...
(function ($, window) {
    var simCardInfo = {
        ...
        add: function () {
            ...
            $('#div_dialog').window('refresh', "/TobaccoGms1/index.php?m=Service&c=SimCardInfo&a=add_edit&type=add");
        ...
        edit: function (value) {
            ...
            $('#div_dialog').window('refresh', "/TobaccoGms1/index.php?m=Service&c=SimCardInfo&a=add_edit&type=edit&ID=" + value);
            ...
            if (id && groupID) {
                $.messager.confirm('注意', '此操作不可恢复是否确定？', function (r){
                    ...
                    $.messager.confirm(that.lang.prompt, that.lang.sureDelete, function (r) {
                        if (r) {
                            $.ajax({
                                url: "/TobaccoGms1/index.php?m=Service&c=simCardInfo&a=Delete",
                                type: 'Post',
                                dataType: 'Json',
                                data: {
                                    id: id,
        ...
        operate: function (value, row, index) {
            ...
            if (result_edit) {
                html = html + "<a href='javascript:;' style='text-decoration: none;' onclick='window.simCardInfo.edit(\"" + row.id + "\")'>" +
            ...
            if (result_del) {
                html = html + "<a href='javascript:;' style='text-decoration: none;' onclick='window.simCardInfo.deleteData(\"" + row.id + "\",\"" + row.group_id + "\")'>" +
        ...
        operateSure: function () {
            ...
            $("#form_sim").form('submit', {

                url: "/TobaccoGms1/index.php?m=Service&c=SimCardInfo&a=" + action,
                onSubmit: function () {
                    var flag = true;

                    flag = flag && $("#inp_simcard_no").textbox('isValid');

                    flag = flag && $("#inp_sim_imei").numberbox('isValid');

                    flag = flag && $("#inp_group_id").combotree('isValid');

                    flag = flag && $("#inp_sim_open_time").datebox('isValid');

                    flag = flag && $("#inp_network_type").combobox('isValid');

                    var str1 = $("#inp_network_type").combobox('getValue');
                    if ('--请选择--' == str1) {
                        flag = false;
                    }
        ...
        moveGroup: function () {
            ...
            $('#div_dialog_changeGroup').window('refresh', "/TobaccoGms1/index.php?m=Service&c=simCardInfo&a=changeGroup");
        ...
        moveGroupSure: function () {
            ...
            $.ajax({
                url:'/TobaccoGms1/index.php?m=Service&c=simCardInfo&a=changeGroup'
            })
    ...
    return window.simCardInfo = window.simCardInfo || simCardInfo;
})($, window);
