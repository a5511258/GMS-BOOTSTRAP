...
function OverNineScreen() {
    if (g_nScreenStyle == 9) {
        document.getElementById("id_ninesrceen").style.background = "url('Public/Manager/keda/images/nine_screen_dis.bmp')";
        return;
    }
    document.getElementById("id_ninesrceen").style.background = "url('Public/Manager/keda/images/nine_screen_over.bmp')";
}
function OutNineScreen() {
    if (g_nScreenStyle == 9) {
        document.getElementById("id_ninesrceen").style.background = "url('Public/Manager/keda/images/nine_screen_dis.bmp')";
        return;
    }
...
function DownNineScreen() {
    if (g_nScreenStyle == 9) {
        document.getElementById("id_ninesrceen").style.background = "url('Public/Manager/keda/images/nine_screen_dis.bmp')";
        return;
    }
    document.getElementById("id_ninesrceen").style.background = "url('Public/Manager/keda/images/nine_screen_press.bmp')";
}
function UpNineScreen() {
    if (g_nScreenStyle == 9) {
        document.getElementById("id_ninesrceen").style.background = "url('Public/Manager/keda/images/nine_screen_dis.bmp')";
        return;
    }
...
function OverSixteenScreen() {
    if (g_nScreenStyle == 16) {
        document.getElementById("id_sixteensrceen").style.background = "url('Public/Manager/keda/images/sixteen_screen_dis.bmp')";
        return;
    }
    document.getElementById("id_sixteensrceen").style.background = "url('Public/Manager/keda/images/sixteen_screen_over.bmp')";
}
function OutSixteenScreen() {
    if (g_nScreenStyle == 16) {
        document.getElementById("id_sixteensrceen").style.background = "url('Public/Manager/keda/images/sixteen_screen_dis.bmp')";
        return;
    }
...
function DownSixteenScreen() {
    if (g_nScreenStyle == 16) {
        document.getElementById("id_sixteensrceen").style.background = "url('Public/Manager/keda/images/sixteen_screen_dis.bmp')";
        return;
    }
    document.getElementById("id_sixteensrceen").style.background = "url('Public/Manager/keda/images/sixteen_screen_press.bmp')";
}
function UpSixteenScreen() {
    if (g_nScreenStyle == 16) {
        document.getElementById("id_sixteensrceen").style.background = "url('Public/Manager/keda/images/sixteen_screen_dis.bmp')";
        return;
    }
...
function OutFullScreen() {
    document.getElementById("id_fullscreen").style.background = "url('Public/Manager/keda/images/full_screen_normal.bmp')";
}
    ...
    if(g_bWndVoiceUsable == 1){
        ...
        if (handle != -1) {//当前视频播放中
            ...
            if(h!=65535){
                ...
                //    修改按钮样式
                document.getElementById("id_audiocall").style.background = "url('Public/Manager/keda/images/realplay/audiocall_disable.png')";
            }else{
...
function OutPTZLeftUp() {
    document.getElementById("id_ptzleftup").style.background = "url(Public/Manager/keda/images/realplay/leftup.png)";
    document.getElementById("id_ptzleftup").style.backgroundSize = "contain";
}
...
function OutPTZUp() {
    document.getElementById("id_ptzup").style.background = "url('Public/Manager/keda/images/realplay/up.png')";
    document.getElementById("id_ptzup").style.backgroundSize = "contain";
}
function DownPTZUp() {
...
function OutPTZRightUp() {
    document.getElementById("id_ptzrightup").style.background = "url('Public/Manager/keda/images/realplay/rightup.png')";
    document.getElementById("id_ptzrightup").style.backgroundSize = "contain";
}
...
function OutPTZLeft() {
    document.getElementById("id_ptzleft").style.background = "url('Public/Manager/keda/images/realplay/left.png')";
    document.getElementById("id_ptzleft").style.backgroundSize = "contain";
}
...
function OverPTZReset() {
    document.getElementById("id_ptzreset").style.background = "url('Public/Manager/keda/images/realplay/reset_over.png')";
    document.getElementById("id_ptzreset").style.backgroundSize = "contain";
}
function OutPTZReset() {
    document.getElementById("id_ptzreset").style.background = "url('Public/Manager/keda/images/realplay/reset.png')";
    document.getElementById("id_ptzreset").style.backgroundSize = "contain";
}
function DownPTZReset() {
    document.getElementById("id_ptzreset").style.background = "url('Public/Manager/keda/images/realplay/reset_press.png')";
    document.getElementById("id_ptzreset").style.backgroundSize = "contain";
}
function UpPTZReset() {
    document.getElementById("id_ptzreset").style.background = "url('Public/Manager/keda/images/realplay/reset_over.png')";
...
function OutPTZRight() {
    document.getElementById("id_ptzright").style.background = "url('Public/Manager/keda/images/realplay/right.png')";
    document.getElementById("id_ptzright").style.backgroundSize = "contain";
}
...
function OutPTZLeftDown() {
    document.getElementById("id_ptzleftdown").style.background = "url('Public/Manager/keda/images/realplay/leftdown.png')";
    document.getElementById("id_ptzleftdown").style.backgroundSize = "contain";
}
...
function OutPTZDown() {
    document.getElementById("id_ptzdown").style.background = "url('Public/Manager/keda/images/realplay/down.png')";
    document.getElementById("id_ptzdown").style.backgroundSize = "contain";
}
...
function OutPTZRightDown() {
    document.getElementById("id_ptzrightdown").style.background = "url('Public/Manager/keda/images/realplay/rightdown.png')";
    document.getElementById("id_ptzrightdown").style.backgroundSize = "contain";
}
...
function OverPTZFocusFar() {
    document.getElementById("id_ptzfocusfar").style.background = "url('Public/Manager/keda/images/realplay/focusfar_over.png')";
    document.getElementById("id_ptzfocusfar").style.backgroundSize = "contain";
}
function OutPTZFocusFar() {
    document.getElementById("id_ptzfocusfar").style.background = "url('Public/Manager/keda/images/realplay/focusfar.png')";

    document.getElementById("id_ptzfocusfar").style.backgroundSize = "contain";
}
function DownPTZFocusFar() {
    document.getElementById("id_ptzfocusfar").style.background = "url('Public/Manager/keda/images/realplay/focusfar_press.png')";
...
function OverPTZFocusNear() {
    document.getElementById("id_ptzfocusnear").style.background = "url('Public/Manager/keda/images/realplay/focusnear_over.png')";
    document.getElementById("id_ptzfocusnear").style.backgroundSize = "contain";
}
function OutPTZFocusNear() {
    document.getElementById("id_ptzfocusnear").style.background = "url('Public/Manager/keda/images/realplay/focusnear.png')";
    document.getElementById("id_ptzfocusnear").style.backgroundSize = "contain";
}
function DownPTZFocusNear() {
    document.getElementById("id_ptzfocusnear").style.background = "url('Public/Manager/keda/images/realplay/focusnear_press.png')";
