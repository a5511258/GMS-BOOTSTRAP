  ...
  <div class="fixed-bar" id="AuthRule_Bar" style="height: auto">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a class="current"href="<?php echo U('Admin/AuthRule/add');?>"><span>新增</span></a></li>
      </ul>
    </div>
  </div>
  <form id="AuthRule_Form" method="post">
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="pid" class="easyui-combotree" style="height:30px;" data-options="value:'<?php echo I('get.pid',0);?>',url:'<?php echo U('Admin/Function/get_auth_rule');?>&pid=-1&r_type=json',multiple:false,required:false,editable:false">
            </select></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input name="title" type="text" class="easyui-textbox" style="height:30px;" value="" data-options="required:false"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input name="name" type="text" class="easyui-textbox" style="height:30px;" value="" data-options="required:false"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label for="for_icon">图标:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><select name="icon" id="for_icon" class="easyui-combobox" style="height:30px;" data-options="value:'',url:'<?php echo U("Admin/Function/get_icon");?>&r_type=json',valueField:'id',textField:'text',multiple:false,required:false,editable:false,    
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="type" class="easyui-combobox" style="height:30px;" data-options="value:'1',multiple:false,required:false,editable:false">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="hide" class="easyui-combobox" style="height:30px;" data-options="value:'0',multiple:false,required:false,editable:false">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="status" class="easyui-combobox" style="height:30px;" data-options="value:'1',multiple:false,required:false,editable:false">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input name="sort" value="0" type="text" class="easyui-numberbox" style="height:30px;" data-options="precision:'0',decimalSeparator:'.',groupSeparator:',',required:false"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input name="condition" value="" type="text" class="easyui-textbox" data-options="required:false,multiline:true" style="width:300px; height:80px;"></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tfoot>
