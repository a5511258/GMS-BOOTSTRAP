...
use Service\Model\VehicleRoadTollViewModel;

class VehicleRoadTollInfoController extends ServiceCoreController
{
    ...
    protected function _initialize() {
        ...
        parent::_initialize ();
        //设置控制器默认模型
        $this->Model = D('vehicle_road_toll_info');
    }
    ...
    {
        return new VehicleRoadTollViewModel();
    }

    public function getVehicleRoadTollInfoToList()
    {
    ...
    public function Update(){
        ...
        if(IS_POST){
            ...
            $Model = new VehicleRoadTollViewModel();
